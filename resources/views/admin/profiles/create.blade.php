    ...
    <div class="card-body p-4">
        <form method="POST" action="{{ route('admin.profiles.store') }}">
            ...
            <div class="mb-3">
                ...
                <textarea name="about" rows="5" class="form-control @error('about') is-invalid @enderror" required>{{ old('about') }}</textarea>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="mission" rows="3" class="form-control @error('mission') is-invalid @enderror">{{ old('mission') }}</textarea>
