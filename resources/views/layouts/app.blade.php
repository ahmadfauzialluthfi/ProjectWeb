...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        ...
        .product-card:hover {
            transform: translateY(-6px); box-shadow: 0 12px 40px rgba(0,0,0,.12);
        }
        ...
        .footer a { color: rgba(255,255,255,.75); text-decoration: none; transition: color 0.2s; }
        ...
        .feature-card:hover {
            transform: translateY(-4px); box-shadow: 0 8px 30px rgba(0,0,0,.08);
        }
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="nav">
                <ul class="navbar-nav ms-auto align-items-lg-center gap-1">
                    ...
                    <li class="nav-item"><a href="{{ route('product') }}" class="nav-link {{ request()->routeIs('product') ? 'active' : '' }}">Product</a></li>
                    <!-- <li class="nav-item"><a href="{{ route('gallery') }}" class="nav-link {{ request()->routeIs('gallery') ? 'active' : '' }}">Gallery</a></li> -->
                    <li class="nav-item"><a href="{{ route('news') }}" class="nav-link {{ request()->routeIs('news*') ? 'active' : '' }}">Berita</a></li>
    ...
    <footer class="footer bg-success text-white pt-5 pb-3">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4">
                    <h5 class="fw-bold mb-3"><i class="bi bi-cup-hot-fill me-2"></i>Local Juice</h5>
                    <p style="opacity: .85;">{{ Str::limit(optional($profile)->about ?? 'Olahan Buah Segar — menyajikan minuman buah berkualitas dengan konsep yang unik dan rasa yang autentik.', 150) }}</p>
                </div>
                <div class="col-lg-4">
                    <h5 class="fw-bold mb-3">Kontak</h5>
                    <p class="mb-2" style="opacity: .85;">
                        <i class="bi bi-geo-alt me-2"></i>{{ optional($profile)->address ?? 'Jl. H.Dulwanih Sawangan Kota Depok' }}
                    </p>
                    <p class="mb-2" style="opacity: .85;">
                        <i class="bi bi-telephone me-2"></i>{{ optional($profile)->phone ?? '0851-2353-3853' }}
                    </p>
                    <p class="mb-0" style="opacity: .85;">
                        <i class="bi bi-envelope me-2"></i>{{ optional($profile)->email ?? 'localjuiceid@gmail.com' }}
                    </p>
                </div>
                <div class="col-lg-4">
                    <h5 class="fw-bold mb-3">Ikuti Kami</h5>
                    <div class="d-flex gap-2">
                        <a href="#" class="btn btn-outline-light btn-lg rounded-circle" style="width:44px;height:44px;padding:0;display:flex;align-items:center;justify-content:center;">
            ...
            <p class="text-center mb-0" style="opacity: .75;">&copy; {{ date('Y') }} Local Juice. All rights reserved.</p>
        </div>
    </footer>
